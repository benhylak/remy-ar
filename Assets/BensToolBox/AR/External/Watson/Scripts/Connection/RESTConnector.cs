        ...
        private IEnumerator ProcessRequestQueue()
        {
            ...
            while (_requests.Count > 0)
            {
                ...
                foreach (var kp in req.Parameters)
                {
                    ...
                    {
                        UnityEngine.Debug.LogError("Unsupported value type: " + value.GetType().Name);
                ...
                if (!string.IsNullOrEmpty(unityWebRequest.error))
                {
                    ...
                    if (bError)
                    {
                        UnityEngine.Debug.LogError(String.Format("URL: {0}, ErrorCode: {1}, Error: {2}, Response: {3}",
                            url, unityWebRequest.responseCode, unityWebRequest.error));
                ...
                {
                    UnityEngine.Debug.Log("Watson Error: Request timed out");
